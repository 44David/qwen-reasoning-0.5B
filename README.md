...
we can add chain-of-thorugh thinking traces to models smaller in size than their teacher models, from which the thinking traces data is collected. 

Allowing chain-of-thought reasoning in models that otherwise do not have this capability. 

You can find the dataset I created for SCoTD here: https://huggingface.co/datasets/44David/SCoTD-deepseek-math-7B
